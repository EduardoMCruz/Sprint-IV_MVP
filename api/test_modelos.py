...
def test_modelo_lr():
    ...
    lr_path = "ml_model/covid-19_lr.pkl"
    ...
    assert acuracia_lr >= 0.65
    assert recall_lr >= 0.6
    assert precisao_lr >= 0.6
    assert f1_lr >= 0.6
...
def test_modelo_knn():
    ...
    knn_path = "ml_model/covid-19_knn.pkl"
    ...
    assert recall_knn >= 0.6
    assert precisao_knn >= 0.6
    assert f1_knn >= 0.6
